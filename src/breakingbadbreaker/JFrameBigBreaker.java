...
public class JFrameBigBreaker extends JFrame implements Runnable, KeyListener, MouseListener, MouseMotionListener {
    ...
    public JFrameBigBreaker() {
        ...
        blockSize = 14;
        Bloque aux1 = new Bloque(80, 100);
        Bloque aux2 = new Bloque(152, 100);
        Bloque aux3 = new Bloque(224, 100);
        Bloque aux4 = new Bloque(296, 100);
        Bloque aux5 = new Bloque(368, 100);
        Bloque aux6 = new Bloque(440, 100);
        Bloque aux7 = new Bloque(512, 100);
        Bloque aux8 = new Bloque(584, 100);
        Bloque aux9 = new Bloque(656, 100);
        Bloque aux10 = new Bloque(728, 100);
        Bloque aux11 = new Bloque(800, 100);
        Bloque aux12 = new Bloque(872, 100);
        Bloque aux13 = new Bloque(944, 100);
        Bloque aux14 = new Bloque(1016, 100);
        Bloque aux15 = new Bloque(1088, 100);
        Bloque aux16 = new Bloque(732, 30);
        Bloque aux17 = new Bloque(732, 30);
        Bloque aux18 = new Bloque(732, 30);
        Bloque aux19 = new Bloque(732, 30);
        Bloque aux20 = new Bloque(732, 30);
        Bloque aux21 = new Bloque(732, 30);
        Bloque aux22 = new Bloque(732, 30);
        Bloque aux23 = new Bloque(732, 30);
        Bloque aux24 = new Bloque(732, 30);
        Bloque aux25 = new Bloque(732, 30);
        Bloque aux26 = new Bloque(732, 30);
        Bloque aux27 = new Bloque(732, 30);
        Bloque aux28 = new Bloque(732, 30);
        Bloque aux29 = new Bloque(732, 30);
        Bloque aux30 = new Bloque(732, 30);
        aux1.setContador(0);
        aux2.setContador(0);
        aux3.setContador(0);
        aux4.setContador(0);
    ...
    /**
     * Metodo onde empieza el hilo del <code>JFrame</code>.
     */
    public void run() {
    ...
    public void actualiza() {
        ...
        if (!gameOver) {
            ...
            if (!pausado) {
                ...
                bola.setPosX(bola.getPosX() + (int) bola.getVelX());
                bola.setPosY(bola.getPosY() + (int) bola.getVelY());
    ...
    public void checaColision() {
        ...
        if (bola.intersecta(barra)) {
            ...
            if (posBola > barra.getPosX() + 50 && posBola < barra.getPosX() + 100) {
                bola.setVelY(-bola.getVelY());
            } else if (posBola <= barra.getPosX() + 50) {
                bola.setVelX(bola.getVelX() - (float) .9);
                bola.setVelY(-(bola.getVelY() + (float) .9));
        ...
        for (int c = 0; c < blockSize; c++) {
            ...
            if (aux.getContador() >= 0) {
                if (bola.intersecta(aux)) {
                    ...
                    if (!reciente) {
                        int checa = 1;
                        if (bola.getPosX() + bola.getAncho() - 5 < aux.getPosX() && checa == 1/* && bola.getPosY() > aux.getPosY() + aux.getAlto() && bola.getPosY() < aux.getPosY()*/) {
                            bola.setVelX(-bola.getVelX());
                            checa = 0;
                            reciente = true;
                        } else if (bola.getPosX() > aux.getPosX() + aux.getAncho() - 5 && checa == 1/* && bola.getPosY() > aux.getPosY() + aux.getAlto() && bola.getPosY() < aux.getPosY()*/) {
                            bola.setVelX(-bola.getVelX());
                            checa = 0;
                            reciente = true;
                        } else if (bola.getPosY() > aux.getPosY() && checa == 1) {
                            bola.setVelY(-bola.getVelY());
                            checa = 0;
                            reciente = true;
                        } else if (bola.getPosY() < aux.getPosY() && checa == 1) {
